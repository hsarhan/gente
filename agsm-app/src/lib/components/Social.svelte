<div class="grid mx-auto my-2 text-center lg:mx-0 lg:text-right lg:justify-end">
    ...
    <ul class="w-fit h-fit mx-auto lg:mx-0 mt-4 lg:mt-0 grid auto-cols-max grid-flow-col gap-3 lg:justify-end lg:justify-self-end items-center align-middle">
        <li>
            <a
            href="https://facebook.com/gentedaserradamantiqueira/"
            rel="noreferrer"
            target="_blank"
        ...
        <li>
            <a
            href="https://www.instagram.com/gentedaserradamantiqueira/"
            rel="noreferrer"
            target="_blank"
            class="text-secondary-800 transition hover:opacity-75 dark:text-primary-100"
            >
        ...
        <li>
            <a
            href="https://wa.me/5535910171305"
            rel="noreferrer"
            target="_blank"
            class="text-secondary-800 transition hover:opacity-75 dark:text-primary-100"
            >
            ...
            <svg class="size-5" fill="currentColor" viewBox="0 0 23 24" aria-hidden="true">
